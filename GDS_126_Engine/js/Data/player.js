...
var playerData ={
	...
	states:{
    	...
    	idle:
		{
			...
			frames:
			[
				{width:16, height:34, startX:0, startY:0},
				// {width:18, height:34, startX:128, startY:0}
		...
		walk:
		{
			...
			frames:
			[
				{width:16, height:34, startX:40, startY:0},
				{width:16, height:34, startX:56, startY:0},
				{width:16, height:34, startX:72, startY:0},
		...
		jump:
		{
			...
			frames:
			[
				{width:16, height:34, startX:113, startY:0}
			]
		},
		...
		crouch:
		{
			...
			frames:
			[
				{width:16, height:34, startX:21, startY:0},
		...
		attack:
		{
			...
			frames:
			[
				// {width:16, height:34, startX:94, startY:0},
				{width:16, height:34, startX:75, startY:0},
